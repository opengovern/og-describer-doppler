...
func processProject(ctx context.Context, handler *resilientbridge.ResilientBridge, resourceID string) (*provider.ProjectJSON, error) {
	var projectGetResponse provider.ProjectGetResponse
