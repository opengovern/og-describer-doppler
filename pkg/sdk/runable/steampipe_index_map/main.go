...
func main() {
	...
	if resourceTypesFile == nil || len(*resourceTypesFile) == 0 {
		...
		rt := "C:\\Users\\ASUS\\GolandProjects\\og-describer-doppler\\provider\\resource_types\\resource-types.json"
		resourceTypesFile = &rt
	}

	if indexMap == nil || len(*indexMap) == 0 {
		v := "C:\\Users\\ASUS\\GolandProjects\\og-describer-doppler\\steampipe\\table_index_map.go"
